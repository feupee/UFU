...
O arquivo chicago.csv contem dados de mortalidade diaria (todas as causas exceto acidentes (death), doencas cardiovasculares (cvd), respiratorias(resp)) e clima (temperatura media em °F (temp), umidade relativa media (rhum)) para a cidade de Chicago no periodo 1997-2000. Os dados sao do National Morbidity, Mortality and Air Pollution Study. Importe a partir da funcao read.csv o arquivo chicago.csv para o R. Alem das colunas descritas acima, o conjunto tambem contem as seguintes variaveis: time: sequencia da observacao; year: ano da observacao; month: mes da observacao; day: dia da observacao; season: estacao do ano.
