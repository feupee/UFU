...
public class TelaDeposito extends JFrame {
    ...
    public TelaDeposito(ContaBancaria conta) {
        this.conta = conta;
        initComponents();
    }

    private void initComponents() {
        setTitle("Depósito - Conta " + conta.getNumeroConta());
        setSize(400, 350);
        ...
        // Título
        mainPanel.add(SwingUtils.criarLabelTitulo("Realizar Depósito"));
        ...
        panelForm.add(new JLabel("Valor do depósito:"));
        ...
        JButton btnConfirmar = SwingUtils.criarBotaoEstilizado("Confirmar Depósito");
        JButton btnCancelar = SwingUtils.criarBotaoEstilizado("Cancelar", Color.GRAY, Color.WHITE);

        btnConfirmar.addActionListener(this::realizarDeposito);
